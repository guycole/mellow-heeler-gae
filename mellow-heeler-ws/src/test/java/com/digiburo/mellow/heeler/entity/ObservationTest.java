...
public class ObservationTest {
  ...
  public void testDefault() {
    ...
    assertNull(observation.getBssid());
    assertNull(observation.getInstallationUuid());
    assertNull(observation.getLocationUuid());
    assertNull(observation.getObservationUuid());
    assertNull(observation.getSortieUuid());
    assertNull(observation.getTimeStamp());
