...
public class SortieTest {
  ...
  public void testDefault() {
    ...
    assertNotNull(sortie.getTimeStamp());

    assertTrue(Sortie.DEFAULT_UUID.equals(sortie.getInstallationUuid()));
    assertTrue(Sortie.DEFAULT_UUID.equals(sortie.getSortieUuid()));
