...
public class GeographicLocationTest {
  ...
  public void testDefault() {
    ...
    assertNotNull(geographicLocation.getLocation());
    assertNotNull(geographicLocation.getTimeStamp());

    assertTrue(GeographicLocation.DEFAULT_UUID.equals(geographicLocation.getInstallationUuid()));
    assertTrue(GeographicLocation.DEFAULT_UUID.equals(geographicLocation.getLocationUuid()));
    assertTrue(GeographicLocation.DEFAULT_UUID.equals(geographicLocation.getSortieUuid()));
  }
